...
class StrategyUnitTest
{
    ...
    @Test
    void mostAbundant_notEnoughStock_exceptionThrown()
    {
    ...
    @Test
    void mostAbundant_emptyLocationList_exceptionThrown()
    {
        Assert.assertThrows(ShopException.class, () -> this.mostAbundant.findSuitableLocation(productIdsAndQuantity, locations));
    }

    @Test
    void mostAbundant_suitableLocations_locationsFound() {
        Product product1 = new Product();
        product1.setId(1);
        Product product2 = new Product();
        product2.setId(2);
    ...
    @Test
    void singleLocation_suitableLocation_locationFound()
    {
        Product product1 = new Product();
        product1.setId(1);
        Product product2 = new Product();
    ...
    @Test
    void singleLocation_notEnoughStock_exceptionThrown()
    {
        Product product1 = new Product();
        product1.setId(1);
        Product product2 = new Product();
    ...
    @Test
    void singleLocation_emptyLocationList_exceptionThrown()
    {
        Assert.assertThrows(ShopException.class, () -> this.singleLocation.findSuitableLocation(productIdsAndQuantity, locations));
    }
